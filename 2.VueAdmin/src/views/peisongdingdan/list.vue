			...
			<el-table
				...
				<el-table-column label="操作" width="300" :resizable='true' :sortable='false' align="left" header-align="left">
					<template #default="scope">
						...
						<el-button v-if="btnAuth('peisongdingdan','接单')" type="success" @click="peisongjiedanCrossAddOrUpdateHandler(scope.row,'cross','','zhuangtai','已接单','已接单,未接单'.split(',')[0])">接单</el-button>
					</template>
				</el-table-column>
			</el-table>
			<el-pagination 

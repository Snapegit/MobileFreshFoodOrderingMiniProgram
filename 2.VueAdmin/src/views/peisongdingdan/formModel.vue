				...
				<el-row>
					...
					<el-col :span="24">
						<el-form-item label="配送费" prop="peisongfei">
							<el-input class="list_inp" v-model.number="form.peisongfei" placeholder="配送费"
								 type="number" 								:readonly="!isAdd||disabledForm.peisongfei?true:false" />
						</el-form-item>
					</el-col>
...
<script setup>
	...
	const init=(formId=null,formType='add',formNames='',row=null,table=null,statusColumnName=null,tips=null,statusColumnValue=null)=>{
		...
		if(formType == 'add'){
			...
			form.value.zhuangtai='未接单'
			form.value.peisongfei='3'
			formVisible.value = true
		}

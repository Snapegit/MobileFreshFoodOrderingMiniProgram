			...
			<view v-if="lists.length" class="list-box4" :style='{"width":"calc(100% - 220rpx)","padding":"24rpx 24rpx 24rpx 24rpx","margin":"0px 0 0 0","flex":"1","height":"auto"}'>
				...
				<view v-if="list.length>0" @tap="onDetailTap(list[0])" class="list-item" :style='{"width":"100%","padding":"0 0 0 0","margin":"0 0 20rpx 0","position":"relative","height":"auto"}'>
				  <view :style='{"width":"100%","padding":"40rpx 20rpx 40rpx 20rpx","justifyContent":"space-between","display":"flex","height":"auto"}'>
				  	<view :style='{"display":"flex"}' v-if="(userid && isAuth('discussshangpinxinxi','修改')) || (!userid && isAuthFront('discussshangpinxinxi','修改'))" @click.stop="onUpdateTap(list[0].id)">
				  	...
				  	<view :style='{"display":"flex"}' v-if="(userid && isAuth('discussshangpinxinxi','删除')) || (!userid && isAuthFront('discussshangpinxinxi','删除'))" @click.stop="onDeleteTap(list[0].id)">
				...
				<view v-if="list.length>1" class="list-item-body" :style='{"width":"100%","padding":"0 0 0 0","margin":"0 0 20rpx 0","justifyContent":"space-between","display":"flex","height":"auto"}'>
					<view v-if="list.length>1" @tap="onDetailTap(list[1])" :style='{"width":"48%","padding":"0 0 0 0","margin":"0 0 0 0","position":"relative","height":"auto"}'>
					  ...
					  <view :style='{"width":"100%","padding":"40rpx 20rpx 40rpx 20rpx","justifyContent":"space-between","display":"flex","height":"auto"}'>
					  	<view :style='{"display":"flex"}' v-if="(userid && isAuth('discussshangpinxinxi','修改')) || (!userid && isAuthFront('discussshangpinxinxi','修改'))" @click.stop="onUpdateTap(list[1].id)">
					  		<text :style='{"margin":"0 8rpx 0 0","fontSize":"28rpx","lineHeight":"1","color":"#069888","display":"inline-block"}' class="iconfont icon-xiugai1"></text>
					  		<text :style='{"fontSize":"28rpx","lineHeight":"1","color":"#069888","display":"inline-block"}'>修改</text>
					  	</view>
					  	<view :style='{"display":"flex"}' v-if="(userid && isAuth('discussshangpinxinxi','删除')) || (!userid && isAuthFront('discussshangpinxinxi','删除'))" @click.stop="onDeleteTap(list[1].id)">
					  		<text :style='{"margin":"0 8rpx 0 0","fontSize":"28rpx","lineHeight":"1","color":"#cc0000","display":"inline-block"}' class="iconfont icon-shanchu1"></text>
					  		<text :style='{"fontSize":"28rpx","lineHeight":"1","color":"#cc0000","display":"inline-block"}'>删除</text>
					  	</view>
					  </view>
					...
					<view v-if="list.length>2" @tap="onDetailTap(list[2])" :style='{"width":"48%","padding":"0 0 0 0","margin":"0 0 0 0","position":"relative","height":"auto"}'>
					  ...
					  <view :style='{"width":"100%","padding":"40rpx 20rpx 40rpx 20rpx","justifyContent":"space-between","display":"flex","height":"auto"}'>
					  	<view :style='{"display":"flex"}' v-if="(userid && isAuth('discussshangpinxinxi','修改')) || (!userid && isAuthFront('discussshangpinxinxi','修改'))" @click.stop="onUpdateTap(list[2].id)">
					  		<text :style='{"margin":"0 8rpx 0 0","fontSize":"28rpx","lineHeight":"1","color":"#069888","display":"inline-block"}' class="iconfont icon-xiugai1"></text>
					  		<text :style='{"fontSize":"28rpx","lineHeight":"1","color":"#069888","display":"inline-block"}'>修改</text>
					  	</view>
					  	<view :style='{"display":"flex"}' v-if="(userid && isAuth('discussshangpinxinxi','删除')) || (!userid && isAuthFront('discussshangpinxinxi','删除'))" @click.stop="onDeleteTap(list[2].id)">
					  		<text :style='{"margin":"0 8rpx 0 0","fontSize":"28rpx","lineHeight":"1","color":"#cc0000","display":"inline-block"}' class="iconfont icon-shanchu1"></text>
					  		<text :style='{"fontSize":"28rpx","lineHeight":"1","color":"#cc0000","display":"inline-block"}'>删除</text>
					  	</view>
					  </view>
				...
				<view v-if="list.length>3" @tap="onDetailTap(list[3])" class="list-item" :style='{"width":"100%","padding":"0 0 0 0","margin":"0 0 20rpx 0","position":"relative","height":"auto"}'>
				  <view :style='{"width":"100%","padding":"40rpx 20rpx 40rpx 20rpx","justifyContent":"space-between","display":"flex","height":"auto"}'>
				  	<view :style='{"display":"flex"}' v-if="(userid && isAuth('discussshangpinxinxi','修改')) || (!userid && isAuthFront('discussshangpinxinxi','修改'))" @click.stop="onUpdateTap(list[3].id)">
				  		<text :style='{"margin":"0 8rpx 0 0","fontSize":"28rpx","lineHeight":"1","color":"#069888","display":"inline-block"}' class="iconfont icon-xiugai1"></text>
				  		<text :style='{"fontSize":"28rpx","lineHeight":"1","color":"#069888","display":"inline-block"}'>修改</text>
				  	</view>
				  	<view :style='{"display":"flex"}' v-if="(userid && isAuth('discussshangpinxinxi','删除')) || (!userid && isAuthFront('discussshangpinxinxi','删除'))" @click.stop="onDeleteTap(list[3].id)">
				  		<text :style='{"margin":"0 8rpx 0 0","fontSize":"28rpx","lineHeight":"1","color":"#cc0000","display":"inline-block"}' class="iconfont icon-shanchu1"></text>
				  		<text :style='{"fontSize":"28rpx","lineHeight":"1","color":"#cc0000","display":"inline-block"}'>删除</text>
				  	</view>
				  </view>
				...
				<view v-if="list.length>4" class="list-item-body" :style='{"width":"100%","padding":"0 0 0 0","margin":"0 0 0 0","justifyContent":"space-between","display":"flex","height":"auto"}'>
					<view v-if="list.length>4" @tap="onDetailTap(list[4])" :style='{"width":"48%","padding":"0 0 0 0","margin":"0 0 0 0","position":"relative","height":"auto"}'>
					  ...
					  <view :style='{"width":"100%","padding":"40rpx 20rpx 40rpx 20rpx","justifyContent":"space-between","display":"flex","height":"auto"}'>
					  	<view :style='{"display":"flex"}' v-if="(userid && isAuth('discussshangpinxinxi','修改')) || (!userid && isAuthFront('discussshangpinxinxi','修改'))" @click.stop="onUpdateTap(list[4].id)">
					  		<text :style='{"margin":"0 8rpx 0 0","fontSize":"28rpx","lineHeight":"1","color":"#069888","display":"inline-block"}' class="iconfont icon-xiugai1"></text>
					  		<text :style='{"fontSize":"28rpx","lineHeight":"1","color":"#069888","display":"inline-block"}'>修改</text>
					  	</view>
					  	<view :style='{"display":"flex"}' v-if="(userid && isAuth('discussshangpinxinxi','删除')) || (!userid && isAuthFront('discussshangpinxinxi','删除'))" @click.stop="onDeleteTap(list[4].id)">
					  		<text :style='{"margin":"0 8rpx 0 0","fontSize":"28rpx","lineHeight":"1","color":"#cc0000","display":"inline-block"}' class="iconfont icon-shanchu1"></text>
					  		<text :style='{"fontSize":"28rpx","lineHeight":"1","color":"#cc0000","display":"inline-block"}'>删除</text>
					  	</view>
					  </view>
					...
					<view v-if="list.length>5" @tap="onDetailTap(list[5])" :style='{"width":"48%","padding":"0 0 0 0","margin":"0 0 0 0","position":"relative","height":"auto"}'>
					  ...
					  <view :style='{"width":"100%","padding":"40rpx 20rpx 40rpx 20rpx","justifyContent":"space-between","display":"flex","height":"auto"}'>
					  	<view :style='{"display":"flex"}' v-if="(userid && isAuth('discussshangpinxinxi','修改')) || (!userid && isAuthFront('discussshangpinxinxi','修改'))" @click.stop="onUpdateTap(list[5].id)">
					  		<text :style='{"margin":"0 8rpx 0 0","fontSize":"28rpx","lineHeight":"1","color":"#069888","display":"inline-block"}' class="iconfont icon-xiugai1"></text>
					  		<text :style='{"fontSize":"28rpx","lineHeight":"1","color":"#069888","display":"inline-block"}'>修改</text>
					  	</view>
					  	<view :style='{"display":"flex"}' v-if="(userid && isAuth('discussshangpinxinxi','删除')) || (!userid && isAuthFront('discussshangpinxinxi','删除'))" @click.stop="onDeleteTap(list[5].id)">
					  		<text :style='{"margin":"0 8rpx 0 0","fontSize":"28rpx","lineHeight":"1","color":"#cc0000","display":"inline-block"}' class="iconfont icon-shanchu1"></text>
					  		<text :style='{"fontSize":"28rpx","lineHeight":"1","color":"#cc0000","display":"inline-block"}'>删除</text>
					  	</view>
					  </view>
